...
const Navbar = () => {
  ...
  return (
    <header className="w-full bg-gradient-to-r from-blue-500 via-indigo-600 to-red-700 text-white flex items-center justify-between px-6 py-4 sm:px-8 shadow-lg fixed top-0 left-0 z-50 transition-all duration-300">
      <div className="text-3xl font-bold tracking-widest hover:scale-105 transform transition duration-200 cursor-pointer">
        <span className="text-white">
          <Link href="/">Wordzy</Link>
        </span>
      </div>
